...
test_mif25="/home/lukasz/AAtWork/DIP/QCB/PPI2019/files/mif25/29954988.xml"
...
def parseFeature( dom ):
    ...
    for f in dom:
        ...
        ftrDMDom = f.xpath( "./mif:featureDetectionMethod",
                            namespaces = ns )
        if len( ftrDMDom ) > 0:
            ftr['detmeth'] = parseCV( ftrDMDom[0] )
        else:
            ftr['detmeth'] = {}
